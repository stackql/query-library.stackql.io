// GENERATED-STYLE stub: makes the main-site path /docs/command-line-usage/mcp an internal
...
export default function RedirectPage() {
  return <ExternalRedirect to="https://stackql.io/docs/command-line-usage/mcp" />;
}
